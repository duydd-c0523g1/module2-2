package extra.bai17.controller;

import extra.bai16.service.ISpendingService;
import extra.bai16.service.SpendingServiceImpl;
    ...
    public static void showMenu() {
        do {
            try {
                ...
                System.out.println("7. Sort plans by name");
                System.out.println("8. Sort plans by spending amount");
                ...
                switch (option) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        spendingService.ascSortByName();
                        break;
                    case 8:
                        spendingService.descSortBySpendAmount();
                        break;
                    case 0:
                        System.exit(0);
                    default:
